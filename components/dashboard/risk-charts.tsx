            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Tooltip 
                  ...
                  formatter={(value: number, _name: string, item?: { payload?: { name?: string; color?: string } }) => [
                    <span key="value" style={{ color: item?.payload?.color ?? "#ffffff", fontWeight: 600 }}>{value}건</span>,
                    item?.payload?.name ?? ""
                  ]}
                />
              </PieChart>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={reasonData} layout="vertical">
                ...
                <Tooltip
                  ...
                  formatter={(value: number, _name: string, item?: { payload?: { fill?: string } }) => [
                    <span key="value" style={{ color: item?.payload?.fill ?? "#ffffff", fontWeight: 600 }}>{value}건</span>,
                    "탐지 건수"
                  ]}
                />
                <Bar 
